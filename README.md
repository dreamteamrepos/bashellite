...
NOTE: The apt-mirror parameter `base_path` is not defined in `provider.conf`.  This parameter will be dymanically determined based on the mirror_tld and mirror_repo_name used during each sync.
